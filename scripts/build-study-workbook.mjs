...
const readmeRows = [
  ...
  ["Sets and breaks", "Three sets of 38; 60-second breaks after trials 38 and 76; server checkpoint required before each break."],
...
readme.getRange("A1:B13").values = readmeRows;
styleHeader(readme, "A1:B1");
readme.getRange("A2:A13").format.font = { bold: true, color: "#252525" };
readme.getRange("A2:B13").format = {
...
readme.getRange("A1:A13").format.columnWidthPx = 245;
readme.getRange("B1:B13").format.columnWidthPx = 680;
readme.getRange("A2:B13").format.rowHeightPx = 42;
